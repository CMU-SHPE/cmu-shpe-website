                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  {status === 'error' && (
                    <p className="text-shpe-red text-sm bg-red-50 border border-red-200 rounded-lg px-4 py-3">
                      Something went wrong. Please try emailing us directly at shpe@coloradomesa.edu.
                    </p>
                  )}
            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="space-y-5">
                  ...
                  <InfoRow
                    ...
                    value="Thursdays at 6:00 PM — Engineering Building, Room 101"
                  />
                </div>
              </div>
              ...
              <div className="bg-cmu-maroon rounded-xl p-6">
                ...
                <div className="text-shpe-gold text-sm font-semibold">
                  Thursdays @ 6 PM · Engineering 101
                </div>
              </div>
            </div>
          </div>
